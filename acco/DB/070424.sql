...
INSERT INTO `cancelpolicy` (`cancelpolicyid`, `timeofcancel`, `cancelpercentage`, `status`) VALUES
	(1, '24 Hourse Before', '25 %', 1),
	(2, '36 Hourse Before', '50 %', 1),
	(3, '48 hrs before chck in time', '100 %', 1),
	(4, 'Before 48 hrs no penalty', '100 %', 1);
...
-- Dumping data for table acco.logindetail: ~0 rows (approximately)
...
INSERT INTO `user` (`userid`, `firstname`, `lastname`, `address1`, `address2`, `city`, `state`, `country`, `pincode`, `modifieddate`, `phonenumber`, `email`, `createddate`, `imageurl`, `idproof`, `username`, `password`, `cpassword`, `status`) VALUES
	(6, 'muthu', 'n', '51', 'a', 'namakkal', 'TN', 'India', NULL, '2024-03-24 12:11:04', '9876545667', 'muthu@gmail.com', '2023-11-04 12:05:52', '', '', 'muthu', '$2a$08$d6RoA3jT5IhwJwMGW4WzXuSxPRKPqaSoFUNW2S5Cc7aTHpt6gqNIu', '$2a$08$kz/HopbIAm35jn0Yh8RZ6OS6GtxxbkDQm9rnoXnBK5/GaDQSBkXzG', 1),

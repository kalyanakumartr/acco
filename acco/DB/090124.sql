...
INSERT INTO `booking` (`bookingid`, `userid`, `modeoftypeid`, `bhk2count`, `bhk3count`, `firstname`, `lastname`, `email`, `phonenumber`, `address1`, `address2`, `city`, `state`, `country`, `pincode`, `checkin`, `checkout`, `acheckin`, `adults`, `child`, `childage`, `roomtype`, `roomid`, `noofdays`, `price`, `tax`, `totalprice`, `bookedstatusid`, `verificationstatus`, `status`) VALUES
	(23, 10, 1, 1, 0, 'Arjun', 'Test1', 'muthu@stashook.com', '444444', 'Test1', 'Test1', 'Test1', 'TN', 'India', '55555', '2023-12-27 03:00:00', '2023-12-28 04:00:00', NULL, '2', '1', '0', 'Service Apartments', '3', '1', 2899, NULL, 2899, '1', 'Checked', 1),
	(24, 10, 1, 1, 0, 'Arjun', 'Test1', 'muthu@stashook.com', '444444', 'Test1', 'Test1', 'Test1', 'TN', 'India', '55555', '2023-12-27 03:00:00', '2023-12-28 04:00:00', NULL, '2', '1', '0', 'Service Apartments', '6', '1', 2899, NULL, 2899, '1', 'Checked', 1),
	(25, 10, 1, 1, 0, 'Arjun', 'Test1', 'muthu@stashook.com', '444444', 'Test1', 'Test1', 'Test1', 'TN', 'India', '55555', '2023-12-17 03:00:00', '2023-12-18 04:00:00', NULL, '2', '1', '0', 'Service Apartments', '2', '1', 2899, NULL, 2899, '1', 'Checked', 1),
	(26, 10, 1, 1, 0, 'Arjun', 'Test1', 'muthu@stashook.com', '1', 'Test1', 'Test1', 'Test1', 'TN', 'India', '55555', '2023-12-27 03:00:00', '2023-12-28 04:00:00', NULL, '2', '1', '0', 'Service Apartments', '2', '1', 2899, NULL, 2899, '1', 'Checked', 1),
	(27, 10, 1, 1, 0, 'Arjun', 'Test1', 'muthu@stashook.com', '1', 'Test1', 'Test1', 'Test1', 'TN', 'India', '55555', '2023-12-27 03:00:00', '2023-12-28 04:00:00', NULL, '2', '3', '0', 'Service Apartments', '2', '1', 2899, NULL, 2899, '1', 'Checked', 1),
	(29, 10, 1, 0, 1, 'Arjun', 'Test1', 'muthu@stashook.com', '1', 'Test1', 'Test1', 'Test1', 'TN', 'India', '55555', '2023-12-27 03:00:00', '2023-12-28 04:00:00', NULL, '2', '3', '6,8,9', 'Service Apartments', '5', '1', 2899, NULL, 2899, '1', 'Checked', 1),
	(30, 7, 1, 1, 0, 'Tamil', 'Test1', 'tamil@stashook.com', '444444', 'Test1', 'Test1', 'Test1', 'TN', 'India', '55555', '2024-01-13 03:00:01', '2024-01-14 03:00:01', NULL, '2', '3', '5,8,9', 'Service Apartments', '4', '1', 2899, NULL, 2899, '1', 'Checked', 1),
	(44, 17, 1, 2, 2, 'sathish', 'Test1', 'sathish@stashook.com', '2', 'Test1', 'Test1', 'Test1', 'TN', 'India', '55555', '2024-01-13 03:00:01', '2024-01-14 03:00:01', NULL, '20', '1', '7', 'Service Apartments', '11', '1', 12000, NULL, 12000, '1', 'Checked', 1),
	(45, 10, 1, 1, 0, 'Arjun', 'Test1', 'muthu@stashook.com', '1', 'Test1', 'Test1', 'Test1', 'TN', 'India', '55555', '2024-01-13 03:00:01', '2024-01-14 03:00:01', NULL, '4', '1', '7', 'Service Apartments', '12', '1', 2599, NULL, 2599, '1', 'Checked', 1);
   ...
   read_loop: LOOP
    ...
    END IF;
		...
		INSERT INTO temp_table SELECT name,des,price,maintenance,tax,headcount,totalamount,discount,roomtypeid, (avail1 -
			...
			from tariffdetail where roomtypeid=rtid AND  (headcount=adultin OR headcount>=4) AND NAME in ('2BHK','3BHK');
		...
		elseif (roomname1 ='3BHK') then 
			...
			from tariffdetail where roomtypeid=rtid AND  headcount>=3 AND NAME='3BHK';
		End IF;	
...
-- Dumping data for table acco.logindetail: ~19 rows (approximately)

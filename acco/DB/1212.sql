...
-- Dumping data for table acco.booking: ~5 rows (approximately)
DELETE FROM `booking`;
INSERT INTO `booking` (`bookingid`, `userid`, `firstname`, `lastname`, `email`, `phonenumber`, `address1`, `address2`, `city`, `state`, `country`, `pincode`, `checkin`, `checkout`, `acheckin`, `adults`, `child`, `roomtype`, `roomid`, `noofdays`, `price`, `totalprice`, `bookedstatusid`, `verificationstatus`, `status`) VALUES
	(1, 7, 'tamil', 'Test1', 'tamil@stashook.com', '444444', 'Test1', 'Test1', 'Test1', 'TN', 'India', '55555', '2023-10-28 03:00:32', '2023-10-28 03:00:32', '2023-10-23 04:00:00', '4', '1', 'Service Apartment', '0', '0', NULL, NULL, '1', '0', 1),
	(2, 6, 'selvam', 'muthu', 'selvam@gmail.com', '234', '234', '234', 'Namakkal', 'Tamil Nadu', 'India', '637015', '2023-10-23 14:02:00', '2023-10-18 11:02:00', '2023-10-23 15:21:00', '2', '1', 'Service Apartment', '0', '0', NULL, NULL, '1', '0', 1),
	(10, 0, 'Muthalagan', 'N', 'muthu@stashook.com', '09884080613', 'Dev', '33', 'Namakkal', 'Tamil Nadu', 'India', '637015', '2023-10-23 21:54:00', '2023-10-18 20:52:00', '2023-10-23 13:39:00', '1', '2', 'Service Apartment', '0', '0', NULL, NULL, '2', '0', 1),
	(11, 0, 'Arjun', 'Test1', 'arjun@stashook.com', '444444', 'Test1', 'Test1', 'Test1', 'TN', 'India', '55555', '2023-10-23 03:00:01', '2023-10-23 04:00:00', '2023-10-23 03:00:01', '5', '1', 'Service Apartment', '0', '0', NULL, NULL, '1', '0', 1),
	(12, 6, 'devi', 'Test1', 'devi@stashook.com', '444444', 'Test1', 'Test1', 'Test1', 'TN', 'India', '55555', '2023-10-28 03:00:00', '2023-10-10 04:00:00', '0000-00-00 00:00:00', '3', '1', 'Service Apartments', '0', '0', NULL, NULL, '2', '0', 1),
	(22, 17, 'Sathish', 'T', 'sathish@stashook.com', '444444', 'Test1', 'Test1', 'Test1', 'TN', 'India', '55555', '2023-12-11 03:00:00', '2023-12-14 04:00:00', NULL, 'undefined', '1', 'Service Apartments', '8', '2', 500, 500, '1', '', 1);
	    ...
	    FETCH cur1 INTO bookId, actualCheckin, bookedCheckin;
			...
			if (@Count=0) then
				...
				INSERT INTO temp_table ( `bookingid`,  `userid`,  `firstname` ,  `lastname` ,  `email` ,  `phonenumber` ,
				  ...
				  `adults` ,  `child` ,  `roomtype`,  `roomid` ,  `noofdays`,  `price` ,  `totalprice`,  `bookedstatusid` ,
...
DELETE FROM `room`;
INSERT INTO `room` (`roomid`, `roomname`, `roomno`, `groupid`, `basecount`, `price`, `roomsize`, `desc`, `roomsplit`, `internet`, `geyser`, `ac`, `smoking`, `pets`, `alcohol`, `family`, `status`) VALUES
	('1', '2BHK', 1, '1', 4, 1500, 600, 'rooms', 1, 1, 1, 1, 1, 0, 1, 1, 1),
	('10', '2BHK', 10, '1', 4, 1500, 600, 'rooms', 0, 1, 1, 1, 1, 0, 1, 1, 1),
	('11', '3BHK', 11, '1', 6, 2000, 900, 'rooms', 0, 1, 1, 1, 1, 0, 1, 1, 1),
	('12', '2BHK', 12, '1', 4, 1500, 600, 'rooms', 0, 1, 1, 1, 1, 0, 1, 1, 1),
	('2', '2BHK', 2, '1', 4, 1500, 600, 'rooms', 1, 1, 1, 1, 1, 0, 1, 1, 1),
	('3', '2BHK', 3, '1', 4, 1500, 600, 'rooms', 0, 1, 1, 1, 1, 0, 1, 1, 1),
	('4', '2BHK', 4, '1', 4, 1500, 600, 'rooms', 0, 1, 1, 1, 1, 0, 1, 1, 1),
	('5', '2BHK', 5, '1', 4, 1500, 600, 'rooms', 0, 1, 1, 1, 1, 0, 1, 1, 1),
	('6', '2BHK', 6, '1', 4, 1500, 600, 'rooms', 0, 1, 1, 1, 1, 0, 1, 1, 1),
	('7', '3BHK', 7, '1', 6, 2000, 900, 'rooms', 0, 1, 1, 1, 1, 0, 1, 1, 1),
	('8', '2BHK', 8, '1', 4, 1500, 600, 'rooms', 0, 1, 1, 1, 1, 0, 1, 1, 1),
	('9', '2BHK', 9, '1', 4, 1500, 600, 'rooms', 0, 1, 1, 1, 1, 0, 1, 1, 1);
...
-- Dumping data for table acco.user: ~8 rows (approximately)
DELETE FROM `user`;
INSERT INTO `user` (`userid`, `firstname`, `lastname`, `address1`, `address2`, `city`, `state`, `country`, `modifieddate`, `phonenumber`, `email`, `createddate`, `imageurl`, `idproof`, `username`, `password`, `cpassword`, `status`) VALUES
	(6, 'muthu', 'n', '51', 'a', 'namakkal', 'TN', 'India', '2023-12-06 10:49:20', '9876545667', 'muthu@gmail.com', '2023-11-04 12:05:52', '', '', 'muthu', 'muthu', '$2a$08$xC9avRQUIkksqb1V9GFDEu4OqRgo5JKv5U0xa20uzcaceZEVs2FSu', 1),
	(7, 'tamil', 'n', '51', 'a', 'namakkal', 'TN', 'India', '2023-12-01 06:57:39', '9876545667', 'tamil@gmail.com', '2023-11-04 13:31:30', '', '', 'tamil', 'tamil', '$2a$08$9Ay1cWr29pOl9CqutbDrG.ZYlmtYJaKHjV/VDS.EQDOuBcUshDZUO', 1),
	(8, 'admin', NULL, NULL, NULL, NULL, NULL, NULL, '2023-12-01 06:57:35', '988408063', 'admin@gmail.com', '2023-11-29 13:02:45', '', '', 'admin', 'admin', NULL, 1),
	(9, 'tamilselvan', NULL, NULL, NULL, NULL, NULL, NULL, '2023-12-02 10:29:03', '123456', 'tamilselvan@gmail.com', '2023-11-29 13:16:17', '', '', 'tamilselvan', 'tamilselvan', NULL, 1),
	(10, 'arjun', NULL, NULL, NULL, NULL, NULL, NULL, '2023-12-02 10:28:57', '99999123456', 'arjun@gmail.com', '2023-11-29 13:26:12', '', '', 'arjun', 'arjun', NULL, 1),
	(11, 'arjun1', NULL, NULL, NULL, NULL, NULL, NULL, '2023-12-02 10:28:50', '99999123456', 'arjun1@gmail.com', '2023-11-29 13:27:03', '', '', 'arjun1', 'arjun1', NULL, 1),
	(12, 'devi', NULL, NULL, NULL, NULL, NULL, NULL, '2023-12-02 10:28:43', '99999123456', 'devi@gmail.com', '2023-11-29 13:28:54', '', '', 'devi', 'devi', NULL, 1),
	(16, 'uma', 'b', '41', 'a', 'namakkal ', 'TN', 'India', '2023-12-06 16:56:54', '9940975265', 'arjunuma@gmail.com', '2023-12-06 22:12:01', '', '', 'uma', '$2a$08$/3tf3imDeLEX78uTA6M01.z/.y9jjv3t/a5TBX.YtZGKNtF2bgUpC', '$2a$08$4M0T5pdCq0Jz3gLcFzasmeIDLOVTdttowaokIMaVjHayaUpa77XfC', 1),
	(17, 'sathish', 'kumar', '41', 'a', 'namakkal', 'TN', 'India', '2023-12-11 07:12:00', '99409', 'sathish@gmail.com', '2023-12-11 12:42:00', '', '', 'sathish', '$2a$08$qq57Skf/0wj8FT09ykYySesR9H4xkDTi3Dn4zXfs8A6QujQ.RCCJi', '$2a$08$r1ulF77sNwpwuXwiCIO2yuwx19PE009nWeULb1.8tH2fh0RL1nN3S', 1);
...
-- Dumping data for table acco.userrolemap: ~2 rows (approximately)

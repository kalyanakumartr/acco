...
INSERT INTO `booking` (`bookingid`, `userid`, `modeoftypeid`, `bhk2count`, `bhk3count`, `firstname`, `lastname`, `email`, `phonenumber`, `address1`, `address2`, `city`, `state`, `country`, `pincode`, `checkin`, `checkout`, `acheckin`, `adults`, `child`, `childage`, `roomtype`, `roomid`, `roomnos`, `bed`, `imageUrl`, `noofdays`, `price`, `tax`, `totalprice`, `bookedstatusid`, `verificationstatus`, `status`) VALUES
	(23, 10, 1, 1, 0, 'Arjun', 'Test1', 'muthu@stashook.com', '444444', 'Test1', 'Test1', 'Test1', 'TN', 'India', '55555', '2023-12-29 03:00:00', '2023-12-30 04:00:00', NULL, '2', '1', '0', 'Service Apartments', '3', '0', '0', '0', '1', 2899, NULL, 2899, '1', 'Checked', 1),
	(24, 10, 1, 1, 0, 'Arjun', 'Test1', 'muthu@stashook.com', '444444', 'Test1', 'Test1', 'Test1', 'TN', 'India', '55555', '2023-12-29 03:00:00', '2023-12-30 04:00:00', NULL, '2', '1', '0', 'Service Apartments', '6', '0', '0', '0', '1', 2899, NULL, 2899, '1', 'Checked', 1),
	(25, 10, 1, 1, 0, 'Arjun', 'Test1', 'muthu@stashook.com', '444444', 'Test1', 'Test1', 'Test1', 'TN', 'India', '55555', '2024-03-27 00:00:00', '2023-12-28 04:00:00', '2024-01-19 15:22:03', '2', '1', '0', 'Service Apartments', '10,8', '201,202', '0', '0', '1', 2899, NULL, 2899, '1', 'Checked', 1),
	(26, 10, 1, 1, 0, 'Arjun', 'Test1', 'muthu@stashook.com', '1', 'Test1', 'Test1', 'Test1', 'TN', 'India', '55555', '2023-12-27 03:00:00', '2023-12-28 04:00:00', '2024-01-14 12:45:48', '2', '1', '0', 'Service Apartments', '1,2', '101,102', '0', '0', '1', 2899, NULL, 2899, '1', 'Checked', 1),
	(27, 10, 1, 1, 0, 'Arjun', 'Test1', 'muthu@stashook.com', '1', 'Test1', 'Test1', 'Test1', 'TN', 'India', '55555', '2023-12-27 03:00:00', '2023-12-28 04:00:00', NULL, '2', '3', '0', 'Service Apartments', '2', '0', '0', 'images_1704989565170.jpg', '1', 2899, NULL, 2899, '1', 'Checked', 1),
	(29, 10, 1, 0, 1, 'Arjun', 'Test1', 'muthu@stashook.com', '1', 'Test1', 'Test1', 'Test1', 'TN', 'India', '55555', '2023-12-27 03:00:00', '2023-12-28 04:00:00', NULL, '2', '3', '6,8,9', 'Service Apartments', '5', '0', '0', '0', '1', 2899, NULL, 2899, '1', 'Checked', 1),
	(30, 7, 1, 1, 0, 'Tamil', 'Test1', 'tamil@stashook.com', '444444', 'Test1', 'Test1', 'Test1', 'TN', 'India', '55555', '2024-01-13 03:00:01', '2024-01-14 03:00:01', NULL, '2', '3', '5,8,9', 'Service Apartments', '4', '0', '0', '0', '1', 2899, NULL, 2899, '1', 'Checked', 1),
	(44, 17, 1, 2, 1, 'sathish', 'Test1', 'sathish@stashook.com', '2', 'Test1', 'Test1', 'Test1', 'TN', 'India', '55555', '2024-01-13 03:00:01', '2024-01-14 03:00:01', NULL, '20', '1', '7', 'Service Apartments', '11', '0', '0', '0', '1', 12000, NULL, 12000, '1', 'Checked', 1),
	(45, 10, 1, 0, 0, 'Arjun', 'Test1', 'muthu@stashook.com', '1', 'Test1', 'Test1', 'Test1', 'TN', 'India', '55555', '2024-01-13 03:00:01', '2024-01-14 03:00:01', '2024-01-27 15:00:00', '4', '1', '7', 'Service Apartments', '0', '0', '0', '0', '1', 2599, NULL, 2599, '1', 'Checked', 1),
	(76, 6, 1, 2, 0, 'MUTHU', 'Test1', 'MUTHU@stashook.com', '444444', 'Test1', 'Test1', 'Test1', 'TN', 'India', '55555', '2024-03-27 03:00:00', '2024-03-28 04:00:00', '2024-01-18 13:18:51', '2', '3', '5,8,9', '1', '1,2,5', '0', '0', '', '1', 2899, NULL, 2899, '1', 'Checked', 1);
...
CREATE TABLE IF NOT EXISTS `logic` (
  ...
  `firstoption` varchar(50) DEFAULT NULL,
  `forooms` int DEFAULT '0',
  `secondoption` varchar(50) DEFAULT NULL,
  `sorooms` int DEFAULT '0',
  `rprice` double DEFAULT '0',
  `foprice` double DEFAULT '0',
  `soprice` double DEFAULT '0',
...
-- Dumping data for table acco.logic: ~6 rows (approximately)
INSERT INTO `logic` (`logicid`, `adult`, `flattype`, `noofrooms`, `firstoption`, `forooms`, `secondoption`, `sorooms`, `rprice`, `foprice`, `soprice`, `bed`, `totalamount`, `status`) VALUES
	(1, 1, 'bhk1', 1, 'bhk2', 2, '0', 0, 1299, 2899, 0, 0, NULL, 1),
	(2, 2, 'bhk1', 1, 'bhk2', 2, '0', 0, 1599, 2899, 0, 0, NULL, 1),
	(3, 3, 'bhk1', 1, 'bhk2', 2, 'bhk3', 3, 1599, 2899, 3599, 300, NULL, 1),
	(4, 4, 'bhk2', 2, 'bhk3', 3, NULL, 0, 2899, 3599, 0, 0, NULL, 1),
	(5, 5, 'bhk2', 2, 'bhk3', 3, NULL, 0, 2899, 3599, 0, 300, NULL, 1),
	(6, 6, 'bhk3', 3, 'bhk1,bhk2', 3, 'bhk2', 4, 3599, 4498, 5798, 0, NULL, 1);
...
-- Dumping data for table acco.logindetail: ~48 rows (approximately)
...
SET @SQL_QUERY1 =concat('select COUNT(roomname) AS roomcount,rtype ,price,roomname ,CONCAT(GROUP_CONCAT(roomid)) AS roomid,CONCAT(GROUP_CONCAT(roomno)) AS roomnos  from room where roomid NOT IN (',@roomIds,') GROUP BY rtype,price,roomname');
...
INSERT INTO `user` (`userid`, `firstname`, `lastname`, `address1`, `address2`, `city`, `state`, `country`, `pincode`, `modifieddate`, `phonenumber`, `email`, `createddate`, `imageurl`, `idproof`, `username`, `password`, `cpassword`, `status`) VALUES
	(6, 'muthu', 'n', '51', 'a', 'namakkal', 'TN', 'India', NULL, '2024-01-12 16:16:34', '9876545667', 'muthu@gmail.com', '2023-11-04 12:05:52', '', '', 'muthu', '123456', '$2a$08$xC9avRQUIkksqb1V9GFDEu4OqRgo5JKv5U0xa20uzcaceZEVs2FSu', 1),
	...
	(17, 'sathish', 'kumar', '41', 'a', 'namakkal', 'TN', 'India', NULL, '2024-01-08 14:54:54', '99409', 'sathish@gmail.com', '2023-12-11 12:42:00', '', '', 'sathish', 'sathish', '$2a$08$r1ulF77sNwpwuXwiCIO2yuwx19PE009nWeULb1.8tH2fh0RL1nN3S', 1);

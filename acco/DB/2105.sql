...
-- Dumping data for table acco.logindetail: ~68 rows (approximately)
...
INSERT INTO `user` (`userid`, `firstname`, `lastname`, `address1`, `address2`, `city`, `state`, `country`, `pincode`, `modifieddate`, `phonenumber`, `email`, `createddate`, `imageurl`, `idproof`, `username`, `password`, `cpassword`, `status`) VALUES
	(6, 'muthu', 'n', '51', 'a', 'namakkal', 'TN', 'India', NULL, '2024-05-20 06:33:38', '9876545667', 'muthu@stashook.com', '2023-11-04 12:05:52', '', '', 'muthu', '$2a$08$rySHl5QcUK3wOeS3FguZTe71P1hdbJ/RnKz8uWK8TabH1L3.qL3Ei', '$2a$08$jBfwt3tdYWZ.jZ72QOFP8eROhYMELD0Sfp1mRfocoWbouTmDUSqXO', 1),

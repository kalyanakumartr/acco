...
CREATE TABLE IF NOT EXISTS `booking` (
  ...
  `roomid` varchar(250) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci NOT NULL DEFAULT (_utf8mb4''),
  ...
  `commands` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci DEFAULT NULL,
  `status` tinyint NOT NULL DEFAULT '0',
  PRIMARY KEY (`bookingid`) USING BTREE
) ENGINE=InnoDB AUTO_INCREMENT=94 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;

-- Dumping data for table acco.booking: ~23 rows (approximately)
...
-- Dumping data for table acco.logindetail: ~147 rows (approximately)
...
INSERT INTO `room` (`roomid`, `roomname`, `roomno`, `groupid`, `basecount`, `rtype`, `price`, `tax`, `roomsize`, `desc`, `roomsplit`, `internet`, `geyser`, `ac`, `smoking`, `pets`, `alcohol`, `family`, `status`) VALUES
	(1, '2BHK', 101, '1', 4, 2, 2899, NULL, 600, 'rooms', 1, 1, 1, 1, 1, 0, 1, 1, 7),
...
SELECT @SQL_QUERY;
	...
	DEALLOCATE PREPARE stmt3;
	select @roomIds;*/
	SET @roomids = ( SELECT GROUP_CONCAT(roomid) from booking WHERE (checkin  BETWEEN  cin AND  cout  OR checkout BETWEEN  cin  AND  cout  )and NOT roomid="" );

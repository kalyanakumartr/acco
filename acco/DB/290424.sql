...
-- Dumping data for table acco.booking: ~41 rows (approximately)
...
-- Dumping data for table acco.logindetail: ~27 rows (approximately)
...
INSERT INTO `room` (`roomid`, `roomname`, `roomno`, `groupid`, `basecount`, `rtype`, `price`, `tax`, `roomsize`, `desc`, `roomsplit`, `internet`, `geyser`, `ac`, `smoking`, `pets`, `alcohol`, `family`, `status`) VALUES
	...
	(5, '3BHK', 203, '1', 6, 3, 3599, NULL, 900, 'rooms', 0, 1, 1, 1, 1, 0, 1, 1, 7),
	...
	(11, '2BHK', 401, '1', 4, 2, 2899, NULL, 600, 'rooms', 0, 1, 1, 1, 1, 0, 1, 1, 7),
...
CREATE TEMPORARY TABLE IF NOT EXISTS `temp_table` (
  ...
  `acheckin` datetime DEFAULT NULL,
  `acheckout` datetime DEFAULT NULL,
  `adults` varchar(250) DEFAULT NULL,
  `child` varchar(250) DEFAULT NULL,
  `childage` varchar(250) DEFAULT NULL,
  `roomtype` varchar(250) DEFAULT NULL,
  `roomid` varchar(250) DEFAULT NULL,
  `roomnos` varchar(250) DEFAULT NULL,
  `bed` varchar(250) DEFAULT NULL,
  `imageUrl` varchar(250) DEFAULT NULL,
  `noofdays` varchar(250) DEFAULT NULL,
  `price` float DEFAULT NULL,
  `tax` float DEFAULT NULL,
  `subtotal` float DEFAULT NULL,
  `totalprice` float DEFAULT NULL,
  `bookedstatusid` varchar(250) DEFAULT NULL,
  `verificationstatus` varchar(250) DEFAULT NULL,
  `clientfeedback` varchar(250) DEFAULT NULL,
  `commands` varchar(250) DEFAULT NULL,
  `status` tinyint DEFAULT NULL,
  `color` text,
  `romenose` text,
  PRIMARY KEY (`bookingid`) USING BTREE
...
-- Dumping data for table acco.user: ~14 rows (approximately)
...
-- Dumping data for table acco.userrolemap: ~10 rows (approximately)

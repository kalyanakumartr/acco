...
INSERT INTO `booking` (`bookingid`, `userid`, `modeoftypeid`, `bhk2count`, `bhk3count`, `firstname`, `lastname`, `email`, `phonenumber`, `address1`, `address2`, `city`, `state`, `country`, `pincode`, `checkin`, `checkout`, `acheckin`, `adults`, `child`, `childage`, `roomtype`, `roomid`, `roomnos`, `bed`, `imageUrl`, `noofdays`, `price`, `tax`, `totalprice`, `bookedstatusid`, `verificationstatus`, `status`) VALUES
	...
	(26, 10, 1, 1, 0, 'Arjun', 'Test1', 'muthu@stashook.com', '1', 'Test1', 'Test1', 'Test1', 'TN', 'India', '55555', '2023-12-27 03:00:00', '2023-12-28 04:00:00', '2024-01-14 12:45:48', '2', '1', '0', 'Service Apartments', '1,2', '101,102', '0', 'images_1706163210489.jpg', '1', 2899, NULL, 2899, '1', 'Checked', 1),
	...
	(44, 17, 1, 2, 1, 'sathish', 'Test1', 'sathish@stashook.com', '2', 'Test1', 'Test1', 'Test1', 'TN', 'India', '55555', '2024-01-13 03:00:01', '2024-01-14 03:00:01', NULL, '20', '1', '7', 'Service Apartments', '11', '0', '0', 'images_1706163457607.jpg', '1', 12000, NULL, 12000, '1', 'Checked', 1),
...
*/
SET @SQL_QUERY1 =concat('select COUNT(roomname) AS roomcount,rtype ,price,roomname ,GROUP_CONCAT(JSON_ARRAY(roomid ,roomno)) AS roomnoss,CONCAT(GROUP_CONCAT(roomid)) AS roomid,CONCAT(GROUP_CONCAT(roomno)) AS roomnos from room where roomid NOT IN (',@roomIds,') GROUP BY rtype,price,roomname');

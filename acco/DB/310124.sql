...
INSERT INTO `booking` (`bookingid`, `userid`, `modeoftypeid`, `bhk1count`, `bhk2count`, `bhk3count`, `firstname`, `lastname`, `email`, `phonenumber`, `address1`, `address2`, `city`, `state`, `country`, `pincode`, `checkin`, `checkout`, `acheckin`, `adults`, `child`, `childage`, `roomtype`, `roomid`, `roomnos`, `bed`, `imageUrl`, `noofdays`, `price`, `tax`, `totalprice`, `bookedstatusid`, `verificationstatus`, `status`) VALUES
	...
	(25, 10, 1, NULL, 1, 0, 'Arjun', 'Test1', 'muthu@stashook.com', '444444', 'Test1', 'Test1', 'Test1', 'TN', 'India', '55555', '2024-03-27 00:00:00', '2023-12-28 04:00:00', '2024-01-19 15:22:03', '2', '1', '0', 'Service Apartments', '10,8,9', '201,202,303', '0', '0', '1', 2899, NULL, 2899, '1', 'Checked', 1),
...
SELECT * FROM logic WHERE adult=10 AND bhktype1+bhktype2<=@bhk2roomcount AND bhktype3<=@bhk3roomcount ;

...
INSERT INTO `booking` (`bookingid`, `firstname`, `lastname`, `email`, `phonenumber`, `address1`, `address2`, `city`, `state`, `country`, `pincode`, `checkin`, `checkout`, `adults`, `child`, `roomtype`, `roomid`, `bookedstatusid`, `status`) VALUES
	...
	(12, 'Arjun', 'Test1', 'muthu@stashook.com', '444444', 'Test1', 'Test1', 'Test1', 'TN', 'India', '55555', '2023-09-02 03:00:00', '2023-10-10 04:00:00', 'undefined', '1', 'Service Apartments', '0', '0', 1);
...
-- Dumping data for table acco.room: ~5 rows (approximately)
DELETE FROM `room`;

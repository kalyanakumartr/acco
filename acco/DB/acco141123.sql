...
DELETE FROM `room`;
INSERT INTO `room` (`roomid`, `roomname`, `roomno`, `groupid`, `basecount`, `roomsize`, `desc`, `roomsplit`, `internet`, `geyser`, `ac`, `smoking`, `pets`, `alcohol`, `family`, `status`) VALUES
	('1', '2BHK', 1, '1', 4, 600, 'rooms', 1, 1, 1, 1, 1, 0, 1, 1, 1),
	('10', '2BHK', 10, '1', 4, 600, 'rooms', 0, 1, 1, 1, 1, 0, 1, 1, 1),
	('11', '3BHK', 11, '1', 6, 900, 'rooms', 0, 1, 1, 1, 1, 0, 1, 1, 1),
	('12', '2BHK', 12, '1', 4, 600, 'rooms', 0, 1, 1, 1, 1, 0, 1, 1, 1),
	('2', '2BHK', 2, '1', 4, 600, 'rooms', 1, 1, 1, 1, 1, 0, 1, 1, 1),
	('3', '2BHK', 3, '1', 4, 600, 'rooms', 0, 1, 1, 1, 1, 0, 1, 1, 1),
	('4', '2BHK', 4, '1', 4, 600, 'rooms', 0, 1, 1, 1, 1, 0, 1, 1, 1),
	('5', '2BHK', 5, '1', 4, 600, 'rooms', 0, 1, 1, 1, 1, 0, 1, 1, 1),
	('6', '2BHK', 6, '1', 4, 600, 'rooms', 0, 1, 1, 1, 1, 0, 1, 1, 1),
	('7', '3BHK', 7, '1', 6, 900, 'rooms', 0, 1, 1, 1, 1, 0, 1, 1, 1),
	('8', '2BHK', 8, '1', 4, 600, 'rooms', 0, 1, 1, 1, 1, 0, 1, 1, 1),
	('9', '2BHK', 9, '1', 4, 600, 'rooms', 0, 1, 1, 1, 1, 0, 1, 1, 1);
...
-- Dumping data for table acco.userrolemap: ~5 rows (approximately)

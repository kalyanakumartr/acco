...
INSERT INTO `booking` (`bookingid`, `firstname`, `lastname`, `email`, `phonenumber`, `address1`, `address2`, `city`, `state`, `country`, `pincode`, `checkin`, `checkout`, `adults`, `child`, `roomtype`, `roomid`, `bookedstatusid`, `status`) VALUES
	(1, 'Test1', 'Test1', 'muthu@stashook.com', '444444', 'Test1', 'Test1', 'Test1', 'TN', 'India', '55555', '2023-10-28 03:00:32', '2023-10-28 03:00:32', '4', '1', 'Service Apartment', '0', '1', 1),
	(2, 'muthu', 'muthu', 'muthu', '234', '234', '234', 'Namakkal', 'Tamil Nadu', 'India', '637015', '2023-10-22 14:02:00', '2023-10-18 11:02:00', '2', '1', 'Service Apartment', '0', '1', 1),
	...
	(12, 'Arjun', 'Test1', 'muthu@stashook.com', '444444', 'Test1', 'Test1', 'Test1', 'TN', 'India', '55555', '2023-09-02 03:00:00', '2023-10-10 04:00:00', '3', '1', 'Service Apartments', '0', '0', 1);
...
-- Dumping data for table acco.otpstore: ~2 rows (approximately)
DELETE FROM `otpstore`;
INSERT INTO `otpstore` (`otpid`, `userid`, `name`, `phonenumber`, `otp`, `otptype`, `otpctime`, `otpetime`, `status`) VALUES
	(1, 1, 'Muthu1', '988408063', '625003', 'email', '2023-11-28 16:10:11', '2023-11-28 16:20:11', 1),
	(2, 1, 'Muthu1', '988408063', '711357', 'email', '2023-11-28 16:12:06', '2023-11-28 16:22:06', 1);
...
-- Dumping data for table acco.user: ~2 rows (approximately)
DELETE FROM `user`;
INSERT INTO `user` (`userid`, `firstname`, `lastname`, `address1`, `address2`, `city`, `state`, `country`, `modifieddate`, `phonenumber`, `email`, `createddate`, `imageurl`, `idproof`, `username`, `password`, `cpassword`, `status`) VALUES
	...
	(7, 'tamil', 'n', '51', 'a', 'namakkal', 'TN', 'India', '2010-10-24 06:42:00', '9876545667', 'nagam2@gmail.com', '2023-11-04 13:31:30', '', '', 'tamil', '$2a$08$qZq5Ldpn7JcYdQSm60EG4OWJjd/RYMvr5dvreS41I20vqHWs3BqRa', '$2a$08$9Ay1cWr29pOl9CqutbDrG.ZYlmtYJaKHjV/VDS.EQDOuBcUshDZUO', 1);
...
-- Dumping data for table acco.userrolemap: ~6 rows (approximately)

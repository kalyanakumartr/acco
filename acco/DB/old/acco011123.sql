...
-- Dumping data for table acco.fooditem: ~0 rows (approximately)
...
INSERT INTO `user` (`userid`, `firstname`, `lastname`, `address1`, `address2`, `city`, `state`, `country`, `registereddate`, `phonenumber`, `email`, `createddate`, `imageurl`, `idproof`, `username`, `password`, `cpassword`, `status`) VALUES
	...
	(26, 'nagam', 'n', '51', 'a', 'namakkal', 'TN', 'India', '2010-10-24 12:12:00', '9876545667', 'nagam@gmail.com', '2023-11-01 11:32:02', '', '', 'undefined', '$2a$08$CUkEOEGD1EcCs64TSiLdsOH9EDTMjaw076GHkFVMm6d.upW.2F1xm', '$2a$08$t91Sa6v9eUEhQC/c9ZhSBO1xrqFxZXZNt.D3LdRcZEUK5/mfvueoC', b'1'),
	(27, 'nagam1', 'n', '51', 'a', 'namakkal', 'TN', 'India', '2010-10-24 12:12:00', '9876545667', 'nagam1@gmail.com', '2023-11-01 12:04:32', '', '', 'undefined', '$2a$08$pw9.cE9s76clyrqDMaNHM.fI/aqIrtIWXQijl7XStscgLqw3lr5JW', '$2a$08$6pNGCC56/hpc5CRJj55khuaLU/AfBqalMS81T3oAuMmyUD5g9J.Ca', b'1'),
	(28, 'nagam2', 'n', '51', 'a', 'namakkal', 'TN', 'India', '2010-10-24 12:12:00', '9876545667', 'nagam2@gmail.com', '2023-11-01 12:05:55', '', '', 'undefined', '$2a$08$bOWkqnFxaamsv5orqKlZXOuTKGp2WKP1LnuN9tqMvlT4JTsJ1dEgO', '$2a$08$hwd8Q7ZyuvauA1K41t.V5e4itxmP8m6GY47Lmvx77anBgFGNMVj7a', b'1');
